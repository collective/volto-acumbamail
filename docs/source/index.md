...
Welcome to the documentation for {term}`Acumbamail` integration with {term}`Volto`!

<img width="400" alt="Acumbamail Logo" src="./_static/logo.svg">

An integration for the {term}`Acumbamail` service with {term}`Volto` integration.
...
The license for this {term}`add-on` is [MIT](https://raw.githubusercontent.com/collective/volto-acumbamail/refs/heads/main/LICENSE).
